      ...
      <div className="flex flex-col gap-10 w-full max-w-[520px]">
        ...
        <div className="space-y-6">
          ...
          <InputRoot>
            ...
            <InputField
              readOnly
              defaultValue="http://localhost:3000/invite/215644354"
            />
        ...
        <div className="space-y-4">
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">1°</span> | Breno Barcelos
            </span>
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">2°</span> | Dáfine Lira
            </span>
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">3°</span> | Rodrigo Verdine
            </span>
